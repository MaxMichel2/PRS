...
void fun_400c20(int64_t rdi, struct s0* rsi, struct s0* rdx) {
    goto puts;
}

int64_t printf = 0x400c86;

void fun_400c80(struct s0* rdi, struct s0* rsi, ...) {
    goto printf;
}
...
struct s1* fun_400c60(struct s0* rdi, struct s0* rsi) {
    goto strlen;
}

int64_t sendto = 0x400cb6;

int32_t fun_400cb0(int64_t rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto sendto;
}

int64_t perror = 0x400d86;

void fun_400d80(int64_t rdi, struct s0* rsi, struct s0* rdx, ...) {
    goto perror;
}
...
int32_t fun_400d90(struct s0* rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto atoi;
}

int64_t memset = 0x400ca6;

void fun_400ca0(struct s0* rdi, int64_t rsi, int64_t rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto memset;
}

int64_t htons = 0x400c76;

int32_t fun_400c70(int64_t rdi, int64_t rsi, int64_t rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto htons;
}

int64_t strcat = 0x400da6;

void fun_400da0(void* rdi, struct s0* rsi) {
    goto strcat;
}

int64_t socket = 0x400e06;

int32_t fun_400e00(int64_t rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8) {
    goto socket;
}

int64_t ntohs = 0x400d56;

uint16_t fun_400d50(int64_t rdi, struct s0* rsi) {
    goto ntohs;
}

int64_t fopen = 0x400d76;

int64_t fun_400d70(void* rdi, struct s0* rsi) {
    goto fopen;
}

int64_t time = 0x400d16;

int32_t fun_400d10(int64_t rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto time;
}

int64_t getpid = 0x400c46;

int32_t fun_400c40(int64_t rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto getpid;
}

int64_t srand = 0x400cd6;

void fun_400cd0(struct s0* rdi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8, void* r9) {
    goto srand;
}

int64_t strncmp = 0x400c16;

int32_t fun_400c10(void* rdi, void* rsi, int64_t rdx) {
    goto strncmp;
}

int64_t waitpid = 0x400d66;

int32_t fun_400d60(struct s0* rdi, struct s0* rsi, struct s0* rdx) {
    goto waitpid;
}

int64_t fclose = 0x400c56;

void fun_400c50(int64_t rdi, struct s0* rsi, struct s0* rdx) {
    goto fclose;
}

int64_t memcpy = 0x400d06;

void fun_400d00(struct s0* rdi, struct s0* rsi, struct s0* rdx) {
    goto memcpy;
}

int64_t rand = 0x400df6;

int32_t fun_400df0(struct s0* rdi, struct s0* rsi, struct s0* rdx, ...) {
    goto rand;
}

int64_t sprintf = 0x400db6;

void fun_400db0(void* rdi, int64_t rsi, int64_t rdx) {
    goto sprintf;
}

int64_t strncpy = 0x400c06;

void fun_400c00(struct s0* rdi, void* rsi, int64_t rdx) {
    goto strncpy;
}

int64_t fseek = 0x400d46;

void fun_400d40(int64_t rdi, struct s0* rsi, int64_t rdx, int64_t rcx, struct s0* r8, void* r9) {
    goto fseek;
}

int64_t strcmp = 0x400ce6;

int32_t fun_400ce0(struct s0* rdi, struct s0* rsi) {
    goto strcmp;
}
...
int64_t my_connect(int32_t edi, struct s0* rsi, struct s0* rdx) {
    ...
    if (*reinterpret_cast<int32_t*>(&rdx)) {
        fun_400c20("Sending SYN...", rsi, rdx);
    }
    rax5 = fun_400c60(reinterpret_cast<int64_t>(rbp4) - 44, rsi);
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi8) + 4) = 0;
    eax9 = fun_400cb0(rdi8, rsi7, rdx6, 0, rsi, 16);
    if (eax9 < 0) {
        fun_400d80("ERROR on SYN transmission", rsi7, rdx6, "ERROR on SYN transmission", rsi7, rdx6);
        fun_400dc0(1, rsi7, rdx6, 1, rsi7, rdx6);
    }
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi12) + 4) = 0;
    ...
    if (eax13 < 0) {
        fun_400d80("ERROR on SYN-ACK reception. Expected format: SYN-ACK0000", rsi10, 20, "ERROR on SYN-ACK reception. Expected format: SYN-ACK0000", rsi10, 20);
        fun_400dc0(1, rsi10, 20, 1, rsi10, 20);
    }
    if (*reinterpret_cast<int32_t*>(&rdx)) {
        rsi14 = reinterpret_cast<struct s0*>(reinterpret_cast<int64_t>(rbp4) - 80);
        fun_400c80("Received message: %s\n", rsi14, "Received message: %s\n", rsi14);
    }
    fun_400c00(reinterpret_cast<int64_t>(rbp4) - 0x68, reinterpret_cast<int64_t>(rbp4) - 80, 7);
    rcx15 = reinterpret_cast<struct s0*>(reinterpret_cast<int64_t>(rbp4) - 0x6d);
    fun_400c00(rcx15, reinterpret_cast<int64_t>(rbp4) - 80 + 7, 4);
    rdx16 = reinterpret_cast<struct s0*>(reinterpret_cast<int64_t>(rbp4) - 40);
    eax17 = fun_400ce0(reinterpret_cast<int64_t>(rbp4) - 0x68, rdx16);
    if (eax17) {
        fun_400d80("SYN-ACK expected", rdx16, rdx16);
        fun_400dc0(1, rdx16, rdx16);
    }
    eax18 = fun_400d90(reinterpret_cast<int64_t>(rbp4) - 0x6d, rdx16, rdx16, rcx15, rsi, r9_11);
    if (*reinterpret_cast<int32_t*>(&rdx)) {
        fun_400c20("Sending ACK...", rdx16, rdx16);
    }
    rax19 = fun_400c60(reinterpret_cast<int64_t>(rbp4) - 32, rdx16);
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi22) + 4) = 0;
    eax23 = fun_400cb0(rdi22, rsi21, rdx20, 0, rsi, 16);
    if (eax23 < 0) {
        fun_400d80("ERROR on ACK transmission", rsi21, rdx20, "ERROR on ACK transmission", rsi21, rdx20);
        fun_400dc0(1, rsi21, rdx20, 1, rsi21, rdx20);
    }
    fun_400ca0(reinterpret_cast<int64_t>(rbp4) - 96, 0, 16, 0, rsi, 16);
    ...
    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi26) + 4) = 0;
    eax27 = fun_400c70(rdi26, 0, 16, 0, rsi, 16);
...
void fun_400c90(struct s0* rdi, struct s0* rsi) {
    goto gettimeofday;
}
...
int32_t read_command_line(int32_t edi, struct s0* rsi, struct s0* rdx, struct s0* rcx, struct s0* r8, void* r9) {
    ...
    if (edi == 4) 
        goto addr_400f4b_2;
    if (edi == 5) {
        eax7 = fun_400ce0(rcx, "0");
        if (!eax7) {
            addr_400f4b_2:
            eax8 = fun_400ce0(rsi, "127.0.0.1");
            if (eax8) {
                eax9 = fun_400ce0(rsi, "localhost");
                if (eax9) {
                    eax10 = fun_400d90(rdx, "localhost", rdx, rcx, r8, r9);
                    if (eax10 <= 0x3e7 || eax10 > 0x270f) {
                        fun_400c80("incorrect port number", "localhost");
                    }
                    fun_400ca0(r8, 0, 16, rcx, r8, r9);
                    r8->f0 = 2;
                    eax11 = eax10;
                    *reinterpret_cast<uint32_t*>(&rdi12) = *reinterpret_cast<uint16_t*>(&eax11);
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi12) + 4) = 0;
                    eax13 = fun_400c70(rdi12, 0, 16, rcx, r8, r9);
                    edx14 = eax13;
                    r8->f2 = *reinterpret_cast<int16_t*>(&edx14);
                    fun_400d20(rsi, &r8->f4);
                    eax15 = 0;
                } else {
                    fun_400c20("localhost is for babies!", "localhost", rdx);
                    eax15 = -1;
                }
            } else {
                fun_400c20("localhost is for babies!", "127.0.0.1", rdx);
                eax15 = -1;
            }
        } else {
            fun_400c20("usage: ./client server_ip server_port file_name", "0", rdx);
            eax15 = -1;
        }
    } else {
        fun_400c20("usage: ./client server_ip server_port file_name", rsi, rdx);
        eax15 = -1;
    }
    return eax15;
}
...
int64_t main(int32_t edi, struct s2* rsi) {
    ...
    v4 = 0;
    fun_400c90(reinterpret_cast<int64_t>(rbp3) - 0x25050, 0);
    rcx5 = rsi->f32;
    rdx6 = rsi->f16;
    rsi7 = rsi->f8;
    ...
    if (eax10 >= 0) {
        ...
        if (edi == 5) {
            rdi12 = rsi->f32;
            eax14 = fun_400d90(rdi12, rsi7, rdx6, rcx5, r8_8, r9_13);
            v11 = eax14;
        }
        v15 = rsi->f24;
        fun_400da0(reinterpret_cast<int64_t>(rbp3) - 0x700, v15);
        eax16 = fun_400e00(2, 2, 0, rcx5, r8_8);
        v17 = eax16;
        if (v17 < 0) {
            fun_400d80("ERROR opening socket", 2, 0, "ERROR opening socket", 2, 0);
            fun_400dc0(1, 2, 0, 1, 2, 0);
        }
        ...
        *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi27) + 4) = 0;
        ...
        if (v11) {
            rsi27 = v15;
            fun_400c80("Asking for %s on data socket\n", rsi27, "Asking for %s on data socket\n", rsi27);
        }
        rax34 = fun_400c60(v15, rsi27);
        ...
        *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi37) + 4) = 0;
        eax38 = fun_400cb0(rdi37, v15, rdx35, 0, r8_36, 16);
        if (eax38 < 0) {
            fun_400d80("ERROR writing file name", v15, rdx35, "ERROR writing file name", v15, rdx35);
            fun_400dc0(1, v15, rdx35, 1, v15, rdx35);
        }
        eax39 = fun_400d10(0, v15, rdx35, 0, r8_36, 16);
        eax40 = fun_400c40(0, v15, rdx35, 0, r8_36, 16);
        *reinterpret_cast<int32_t*>(&rdi41) = eax40 * eax39;
        *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi41) + 4) = 0;
        fun_400cd0(rdi41, v15, rdx35, 0, r8_36, 16);
        ...
        eax46 = fun_400df0(rdi41, v15, v45, rdi41, v15, v45);
        ...
        do {
            ...
            *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi51) + 4) = 0;
            ...
            if (eax52 < 0) {
                fun_400d80("ERROR receiving file", rsi48, 0x5dc, "ERROR receiving file", rsi48, 0x5dc);
                fun_400dc0(1, rsi48, 0x5dc, 1, rsi48, 0x5dc);
            }
            if (eax52 <= 5 && (eax53 = fun_400c10(reinterpret_cast<int64_t>(rbp3) - 0x690, reinterpret_cast<int64_t>(rbp3) - 0x704, 3), !!eax53)) {
                *reinterpret_cast<int32_t*>(&rsi54) = eax52;
                *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi54) + 4) = 0;
                fun_400c80("Received %d bytes. I need something bigger.\n", rsi54, "Received %d bytes. I need something bigger.\n", rsi54);
            }
            eax55 = fun_400c10(reinterpret_cast<int64_t>(rbp3) - 0x690, reinterpret_cast<int64_t>(rbp3) - 0x704, 3);
            if (eax55) {
                fun_400d00(reinterpret_cast<int64_t>(rbp3) - 0x250c7, reinterpret_cast<int64_t>(rbp3) - 0x690, 6);
                if (v11) {
                    eax56 = v57;
                    ...
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi60) + 4) = 0;
                    fun_400c80("Message Received: %d bytes seq %c%c%c%c%c%c\n", rsi60, "Message Received: %d bytes seq %c%c%c%c%c%c\n", rsi60);
                }
                ...
                fun_400d00(rcx62, reinterpret_cast<int64_t>(rbp3) - 0x690 + 6, rdx61);
                rdi63 = reinterpret_cast<struct s0*>(reinterpret_cast<int64_t>(rbp3) - 0x250c7);
                eax64 = fun_400d90(rdi63, reinterpret_cast<int64_t>(rbp3) - 0x690 + 6, rdx61, rcx62, r8_50, r9_49);
                v65 = 0;
                eax66 = fun_400df0(rdi63, reinterpret_cast<int64_t>(rbp3) - 0x690 + 6, rdx61);
                if (eax66 - ((__intrinsic() >> 5) - (eax66 >> 31)) * 100 <= 10 && (v65 = 1, !!v11)) {
                    ...
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi67) + 4) = 0;
                    fun_400c80("Message %d dropped by the network\n", rsi67, "Message %d dropped by the network\n", rsi67);
                }
            ...
            if (al81) {
                ...
                eax84 = fun_400df0(rdi69, 0, rdx83);
            ...
            if (eax64 >= v4 + 100 || v65) {
                if (v11 && !v65) {
                    *reinterpret_cast<int32_t*>(&rsi68) = eax64;
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi68) + 4) = 0;
                    fun_400c80("Message %d dropped by the receiver\n", rsi68, "Message %d dropped by the receiver\n", rsi68);
                    continue;
                }
            } else {
                v95 = v4;
                if (eax64 > v4) {
                    ...
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(rbp3) + (eax64 - ((__intrinsic() >> 5) - (eax64 >> 31)) * 100) * 4 - 0x8a0) = static_cast<int32_t>(rax96 - 6);
                    ...
                    fun_400d00(rdi69, rsi68, static_cast<int64_t>(eax52 - 6));
                ...
                if (v33 == 0x1f4) {
                    do {
                        ...
                        *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi69) + 4) = 0;
                        eax100 = fun_400d60(0, 0, 1);
                    } while (eax100 != -1);
                    v33 = 0;
                }
                eax101 = fun_400de0(rdi69, rsi68, rdx73);
                if (eax101 < 0) {
                    fun_400d80("ERROR creating process", rsi68, rdx73);
                    fun_400dc0(1, rsi68, rdx73);
                }
                if (!eax101) {
                    *reinterpret_cast<int32_t*>(&rdx102) = v95;
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdx102) + 4) = 0;
                    fun_400db0(reinterpret_cast<int64_t>(rbp3) - 0x250d8, "%06d", rdx102);
                    fun_400c00(reinterpret_cast<int64_t>(rbp3) - 0x250d1, reinterpret_cast<int64_t>(rbp3) - 0x708, 4);
                    rsi103 = reinterpret_cast<struct s0*>(reinterpret_cast<int64_t>(rbp3) - 0x250d8);
                    fun_400da0(reinterpret_cast<int64_t>(rbp3) - 0x250d1, rsi103);
                    rax104 = fun_400c60(reinterpret_cast<int64_t>(rbp3) - 0x250d1, rsi103);
                    ...
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdi106) + 4) = 0;
                    eax107 = fun_400cb0(rdi106, rsi68, rdx105, 0, r8_50, 16);
                    if (v11) {
                        rsi68 = reinterpret_cast<struct s0*>(reinterpret_cast<int64_t>(rbp3) - 0x250d1);
                        fun_400c80("Sent %s\n", rsi68, "Sent %s\n", rsi68);
                    }
                    if (eax107 < 0) {
                        fun_400d80("ERROR sending ACK", rsi68, rdx105, "ERROR sending ACK", rsi68, rdx105);
                        fun_400dc0(1, rsi68, rdx105, 1, rsi68, rdx105);
                    }
                    fun_400dc0(0, rsi68, rdx105, 0, rsi68, rdx105);
                }
                ++v33;
                ...
                *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rdx73) + 4) = 0;
                ...
                while (!reinterpret_cast<uint1_t>(reinterpret_cast<uint1_t>(*reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(rbp3) + v110 * 4 - 0x8a0) < 0) | reinterpret_cast<uint1_t>(*reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(rbp3) + v110 * 4 - 0x8a0) == 0))) {
                    ...
                    if (rax113 != v32) {
                        fun_400d80("ERROR on file position indicator\n", 1, rdx111, "ERROR on file position indicator\n", 1, rdx111);
                        fun_400dc0(1, 1, rdx111, 1, 1, rdx111);
                    }
                    *reinterpret_cast<int32_t*>(&rsi68) = 0;
                    *reinterpret_cast<int32_t*>(reinterpret_cast<int64_t>(&rsi68) + 4) = 0;
                    fun_400d40(v29, 0, 2, v29, r8_50, r9_49);
            ...
            addr_4016ac_36:
            fun_400c20("Received FIN", 0, 1);
        } while (v31);
        if (v11) {
            rsi68 = v32;
            fun_400c80("Total bytes received %ld\n", rsi68, "Total bytes received %ld\n", rsi68);
        }
